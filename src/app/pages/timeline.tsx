...
import { Button, Pill } from 'src/app/components';
import { Layout } from 'src/app/layouts';

import type { GetStaticProps } from 'next';

import type { Timeline, TimelineEvent } from 'src/app/types';
...
export const getStaticProps: GetStaticProps<TimelineProps> = async () => {
	const { default: rawTimeline } = await import('src/app/data/timeline.json');
