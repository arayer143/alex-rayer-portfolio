...
import { Animate, Button, Pill } from 'src/app/components';
import { EventType, NavigationItemType } from 'src/app/types';
import { Layout } from 'src/app/layouts';

import type { EventProps } from 'src/app/components/Event.component';
import type { NavigationItem } from 'src/app/types';

const Event = dynamic<EventProps>(
	() => import('src/app/components/Event.component').then(({ Event }) => Event),
	{
		ssr: false,
	},
);
